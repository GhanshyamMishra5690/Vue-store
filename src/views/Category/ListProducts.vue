    ...
    <div class="container">
        <div class="row">
            <div class="col-12 text-center">
                <h4 class="py-3">{{category.categoryName}}</h4>
                <h5 style="font-weight:300; color:#686868">{{ msg }}</h5>
            </div>
        </div>
        <div class="row">
            <div v-for="product of category.products" :key="product.id" class="col-md-6 col-xl-4 col-12 pt-3 justify-content-round d-flex">
